	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float mulTime19 = _TimeParameters.x * _PanSpeed;
				float2 appendResult17 = (float2(0.0 , mulTime19));
				float2 texCoord13 = packedInput.ase_texcoord1.xy * appendResult21 + appendResult17;
...
Node;AmplifyShaderEditor.CommentaryNode;22;-796.5995,331.1001;Inherit;False;735.9999;205.0999;Alpha Clipping must be set on both Master Node Properties Additional Options and Material Inspector;1;15;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-583.2996,418.0999;Inherit;False;Property;_Cutoff;Cutoff;2;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;11;-231.3001,-281.3;Inherit;False;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.5882353,1,0.6862745,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0C040E84EA6BF8D842B58AD09F0462A153916DB5