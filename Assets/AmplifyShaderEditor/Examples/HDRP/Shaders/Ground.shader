...
Shader "ASESampleShaders/Decals Muddy Ground/Ground"
{
	Properties
	{
		...
		[ASEBegin]_DirtAlbedo("Dirt Albedo", 2D) = "white" {}
		_DirtHeight("Dirt Height", 2D) = "white" {}
		_DirtNormal("Dirt Normal", 2D) = "bump" {}
		[ASEEnd]_Height("Height", Range( 0 , 3)) = 0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-279.5,639;Inherit;False;Property;_Height;Height;3;0;Create;True;0;0;0;False;0;False;0;0.8470588;0;3;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=AA6EE190C2DF051873898510DFFBB8A34CF355D2